...
import 'package:vaclocks/header.dart';
import 'package:window_manager/window_manager.dart';

// 1. هذا هو الـ Layout الرئيسي الذي ستستخدمه في تطبيقك
class VenomScaffold extends StatelessWidget {
...
class _VenomScaffoldBody extends StatefulWidget {
  final Widget body;
  final String title;
  final int index;
  final ValueChanged<int> onIndexChanged;
...
class _VenomScaffoldBodyState extends State<_VenomScaffoldBody> {
      ...
      body: Stack(
        children: [
          ...
          TweenAnimationBuilder<double>(
            ...
            child: Container(
              margin: const EdgeInsets.only(top: 50), // نترك مساحة للـ Appbar
              child: widget.body,
            ),
          ),
